...
public class Level_02_Apply_BasePage_III extends BasePage {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		sendKeyToElement(driver, "//input[@id='FirstName']", "Vu");
		sendKeyToElement(driver, "//input[@id='LastName']", "Chiem");
		sendKeyToElement(driver, "//input[@id='Email']", "chiemv@vn#");
	...
	public void TC_04_Register_Existing_Email() {
		...
		sendKeyToElement(driver, "//input[@id='FirstName']", "Vu2");
		sendKeyToElement(driver, "//input[@id='LastName']", "Chiem2");
		sendKeyToElement(driver, "//input[@id='Email']", emailAddress);
		sendKeyToElement(driver, "//input[@id='Password']", "123456");
		sendKeyToElement(driver, "//input[@id='ConfirmPassword']", "123456");
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		sendKeyToElement(driver, "//input[@id='Email']", emailAddress);
		sendKeyToElement(driver, "//input[@id='Password']", "123456");
		sendKeyToElement(driver, "//input[@id='ConfirmPassword']", "1265433");
